...
export const foundationQueryKeys = {
  welcome: ['foundation', 'welcome'] as const,
  apiHealth: ['api-health'] as const,
} as const;

export const welcomeStepIds = {
  findHelp: 'find-help',
...
export const welcomeFlowTiming = {
  splashDurationMs: 1400,
} as const;
...
export const fallbackWelcomeFlow: WelcomeFlow = {
  ...
  steps: [
    ...
    {
      id: welcomeStepIds.trustedCommunity,
    ...
    {
      id: welcomeStepIds.everydayLife,
