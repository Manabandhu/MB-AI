      ...
      <ScrollView contentContainerStyle={styles.page}>
        <View style={styles.container}>
          ...
          <Text style={styles.subtitle}>
            Rating ride {rideId}. Share feedback on safety, timeliness, and comfort.
          </Text>
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Placeholder</Text>
            <Text style={styles.cardBody}>
              This screen will render the full rating form once the ride rating API is available.
            </Text>
          </View>
          <View style={styles.actions}>
            <AppButton label="Ride history" route="/rides/history" variant="secondary" />
            <AppButton label="View details" route={`/rides/${rideId}`} variant="secondary" />
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
