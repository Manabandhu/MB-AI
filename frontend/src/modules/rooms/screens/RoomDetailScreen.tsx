      ...
      <ScrollView contentContainerStyle={styles.page}>
        <View style={styles.container}>
          ...
          <Text style={styles.subtitle}>
            Viewing room {roomId}. Full listing content, host signals, and contact handoff appear
            here.
          </Text>
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Placeholder</Text>
            <Text style={styles.cardBody}>
              This screen will render the full room detail payload including price, availability,
              household fit, safety notes, and a protected contact handoff once the room detail API
              is available.
            </Text>
          </View>
          <View style={styles.actions}>
            <AppButton label="Edit listing" route={`/rooms/${roomId}/edit`} />
            <AppButton label="Saved rooms" route="/rooms/saved" variant="secondary" />
            <AppButton label="Search more" route="/rooms/search" variant="secondary" />
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
