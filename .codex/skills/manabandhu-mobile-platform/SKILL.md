...
21. Recent client-side fixes: shared Supabase/client imports are grouped before UI imports, `AppButton` supports a `loading` disabled state, and admin navigation uses typed `Href` casts where needed.
