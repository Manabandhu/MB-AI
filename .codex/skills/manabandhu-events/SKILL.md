...
- Hardcoded data cleanup: removed hardcoded attendee counts ("1,420 Desis Attending"), static capacity badges ("95% Capacity"), static carpool counts, and replaced static festival schedule in `EventDetailsScreen` with event-specific timeline derivation and generic schedule fallback.
