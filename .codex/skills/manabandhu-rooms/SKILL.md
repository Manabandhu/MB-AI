...
4. Room discovery screens must expose connected actions between search, map, filters, saved, my listings, create, details, and edit.
5. Protect precise location and contact data; enforce listing ownership, availability, reporting, and moderation server-side.
6. Test map/list synchronization, filters, pagination, saves, empty/error states, and adaptive layouts.
