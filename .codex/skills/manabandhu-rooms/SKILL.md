...
- Fallback cleanup: deleted `roomsFallbacks.ts`, removed `fallbackDetail` from `RoomDetailScreen` in favor of loading/error states, and removed `defaultSavedRooms` from `RoomFavoritesScreen` in favor of real database records.
