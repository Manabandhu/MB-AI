...
3. The first-batch auth routes `/sign-in`, `/sign-up`, and `/forgot-password` use `frontend/src/modules/auth/screens/AuthScreen.tsx`; demo submission returns to `/home` until Supabase auth actions are wired.
