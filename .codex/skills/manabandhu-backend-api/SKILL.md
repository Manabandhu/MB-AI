...
7. Public foundation, notifications, rooms, and rides demo content endpoints must remain read-only, contain no user data, and stay under `/api/v1/foundation`, `/api/v1/notifications`, `/api/v1/rooms`, and `/api/v1/rides`.
